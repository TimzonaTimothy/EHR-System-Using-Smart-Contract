...
contract PatientRecord {
    ...
    function addPatientRecord(
        ...
        string[4] memory billing,
        string[4] memory service,
        string[1] memory amount
    ) public onlyAuthorizedDoctor(patientAddress) {
        patients[patientAddress] = true;
        patientRecords[patientAddress].push(Record(vitalSigns, treatmentDetails, vaccine, prescription,billing, service, amount));
    ...
    function updatePatientRecord(
        ...
        string[4] memory updatedBilling,
        string[4] memory updatedService,
        string[1] memory updatedAmount
    ) public onlyAuthorizedDoctor(patientAddress) {
        ...
        patientRecord.billing = updatedBilling;
        patientRecord.service = updatedService;
        patientRecord.amount = updatedAmount;
